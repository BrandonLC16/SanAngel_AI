# Fase 6 — Contratos de tools (F6.1)
...
`ValidatedToolCall` contiene esa identidad backend para que F6.2 pueda implementar handlers
acotados; F6.1 todavía no consulta la base, no busca la FAQ y no ejecuta ayuda humana.
