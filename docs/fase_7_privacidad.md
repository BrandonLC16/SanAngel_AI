...
Esta política cubre solo las tablas `conversations`, `messages` y
`whatsapp_event_receipts` del backend. No establece una conclusión de cumplimiento legal ni una
